...
import pe.egcc.eurekaapp.controller.MovimientosController;

public class MovimientoEmpleado extends javax.swing.JFrame {

    private MovimientosController control;
    
    public MovimientoEmpleado() {
        initComponents();
        control = new MovimientosController();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            // Proceso
            List<Map<String,Object>> lista = control.getMoveEmpleado(codigo);
            // Reporte
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MovimientoEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MovimientoEmpleado().setVisible(true);
            }
        });
    }
